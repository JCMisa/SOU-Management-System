...
namespace WebSystemFinalProject.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            if(!_roleManager.RoleExistsAsync(StaticDetails.Role_User).GetAwaiter().GetResult())
            {
                ...
                _roleManager.CreateAsync(new IdentityRole(StaticDetails.Role_Super_Admin)).GetAwaiter().GetResult();
            }
